...
//https://api.openweathermap.org/data/2.5/forecast/daily?lat=${lat}&lon=${lon}&cnt=7&appid={API key}
...
function getDataLocation(lat ,lon){
    ...
    const url1=`https://api.openweathermap.org/data/2.5/forecast/daily?q=${city}&cnt=7&appid=41ef8c4a1db85bf49c426b08320cb0bb`
